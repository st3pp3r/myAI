...
export const QUESTION_RESPONSE_TEMPERATURE: number = 0.3;

export const HYDE_MODEL: string = "gpt-4o-mini";
export const HYDE_TEMPERATURE: number = 0.3;
